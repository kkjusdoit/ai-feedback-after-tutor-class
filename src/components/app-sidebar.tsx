...
const NAV_ITEMS = [
  { href: "/", label: "生成反馈", icon: SparklesIcon },
  { href: "/history", label: "历史记录", icon: HistoryIcon },
  { href: "/students", label: "学生档案", icon: StudentsIcon },
];
    ...
    <aside className="fixed left-0 top-0 bottom-0 w-[220px] bg-card border-r border-border flex flex-col z-40">
      ...
      <div className="px-6 py-6 border-b border-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-heading text-[15px] font-semibold text-foreground leading-tight">课后反馈</h1>
            <p className="text-[11px] text-muted-foreground mt-0.5">AI 助手</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-4 border-t border-border">
        <div className="flex items-center gap-3 px-2">
          <div className="w-8 h-8 rounded-full bg-teal-light flex items-center justify-center">
            <span className="text-[13px] font-medium text-teal-dark">师</span>
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-[13px] font-medium text-foreground truncate">林老师</p>
            <p className="text-[11px] text-muted-foreground">数学组</p>
          </div>
        </div>
      </div>
    </aside>
